...
@Component
public class MongoChatMemoryStore implements ChatMemoryStore {//聊天存储在mongodb

    @Autowired
    private MongoTemplate mongoTemplate;

    @Override
    public List<ChatMessage> getMessages(Object mentoryId) {
        Criteria criteria = Criteria.where("memoryId").is(mentoryId);
